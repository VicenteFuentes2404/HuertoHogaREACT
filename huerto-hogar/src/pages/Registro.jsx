...
export default function Registro() {
  ...
  const handleSubmit = (e) => {
    ...
    if (!formData.nombre.trim())
      erroresTemp.nombre = "El nombre completo es obligatorio";

    if (!formData.correo.trim())
      erroresTemp.correo = "El correo electrónico es obligatorio";
    ...
    if (formData.password !== formData.confirmPassword)
      erroresTemp.confirmPassword =
        "La contraseña y su confirmación no coinciden";

    if (
      formData.telefono.trim() &&
      !telefonoRegex.test(formData.telefono.trim())
    )
      erroresTemp.telefono =
        "El teléfono debe contener solo números (7 a 15 dígitos)";

    if (formData.region === "-- Región --")
      erroresTemp.region = "Debes seleccionar una región";
    if (formData.comuna === "-- Comuna --")
      erroresTemp.comuna = "Debes seleccionar una comuna";
                ...
                <div className="card shadow-lg">
                  <div className="card-body p-5">
                    ...
                    <form onSubmit={handleSubmit} noValidate autoComplete="off">
                      ...
                      {/* Correo */}
                      <div className="mb-3">
                        <label htmlFor="correo" className="mb-2 text-muted">
                          Correo
                        </label>
                        <input
                          type="email"
                      ...
                      {/* Teléfono */}
                      <div className="mb-3">
                        <label htmlFor="telefono" className="mb-2 text-muted">
                          Teléfono (opcional)
                        </label>
                        <input
                          type="tel"
